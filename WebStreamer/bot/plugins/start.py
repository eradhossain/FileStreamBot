...
<i><b>🍃 Bᴏᴛ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ :</b>Erad Hossain</i>"""
...
ABOUT_TEXT = """
<b>⚜ Mʏ ɴᴀᴍᴇ : Direct Links</b>\n
<b>🔸Vᴇʀꜱɪᴏɴ : <a href='https://telegram.me/BDSkyMoViEs'>3.0.1</a></b>\n
<b>🔹Sᴏᴜʀᴄᴇ : <a href='https://github.com/eradhossain/FileStreamBot/tree/main'>Cʟɪᴄᴋ Hᴇʀᴇ</a></b>\n
...
<b>🔸Lᴀꜱᴛ ᴜᴘᴅᴀᴛᴇᴅ : <a href='https://telegram.me/BDSkyMoViEs'>[ 26-ᴊan-22 ] 03:55 PM</a></b>"""
    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>Sᴏᴍᴇᴛʜɪɴɢ ᴡʀᴏɴɢ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ</i> <b><a href='http://t.me/EH_UnknownPerson'>[ ᴄʟɪᴄᴋ ʜᴇʀᴇ ]</a></b>",
                    parse_mode="HTML",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="**Sᴏʀʀʏ Sɪʀ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴍᴇ. Qᴜɪᴄᴋʟʏ ᴄᴏɴᴛᴀᴄᴛ** @EH_UnknownPerson",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await b.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                         ...
                         [InlineKeyboardButton("🔄 Refresh / Try Again", url=f"https://t.me/{(await b.get_me()).username}?start=EH_UnknownPerson_{usr_cmd}")
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** [Erad Hossainj](https://t.me/EH_UnknownPerson).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
...
<i>🍃 Bᴏᴛ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ :</i> <b>@EH_UnknownPerson</b>
"""
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Erad Hossian](https://t.me/@EH_UnknownPerson).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
